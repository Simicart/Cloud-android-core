...
//		 requestCatTree();
		onClickItemCat = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				switch (((CategoryZTheme)mCategories.get(position)).getType()) {
				case CategoryZTheme.TYPE_CAT:
					mDelegate.showCatSub(((CategoryZTheme)mCategories.get(position)));
					break;
				case CategoryZTheme.TYPE_SPOT:
					selectSpot(((CategoryZTheme) mCategories.get(position))
