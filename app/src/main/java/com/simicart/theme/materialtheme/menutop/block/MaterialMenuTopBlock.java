package com.simicart.theme.materialtheme.menutop.block;
 ...
 */
public class MaterialMenuTopBlock extends SimiBlock implements MaterialMenuTopDelegate {
    ...
    public MaterialMenuTopBlock(View view, Context context) {
        super(view, context);
    ...
    private void initButtonMenu() {
        ...
        txt_search = (TextView) mView.findViewById(Rconfig.getInstance().id("txt_search"));
        txt_search.setTextColor(Config.getInstance().getTop_menu_icon_color());
        txt_search.setText(Config.getInstance().getText("Search on SimiCart"));
    }
    ...
    protected void initIconCart() {
        iconCart = mContext.getResources().getDrawable(
                Rconfig.getInstance().drawable("material_icon_cart"));
    ...
    public void setOnClickSearch(View.OnClickListener listener){
        txt_search.setOnClickListener(listener);
    }

    public void setOnTouchCart(View.OnTouchListener touchCart) {
        mViewCart.setOnTouchListener(touchCart);
    }

    public void setOnTouchMenu(View.OnTouchListener touchMenu) {
