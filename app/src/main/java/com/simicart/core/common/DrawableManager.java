...
public class DrawableManager {
                ...
                public void handleMessage(Message message) {
                    ...
                    if (bitmap != null) {
                        ...
                        bitmap = BitmapFactory.decodeResource(resources,
                                Rconfig.getInstance().drawable("default_icon"));
    ...
    public static void getBitmap(final Handler handler, final String urlString,
        ...
        Thread thread = new Thread() {
            @Override
            public void run() {
                Bitmap bitmap = excutePostForBitMap(urlString, sampleSize);
                if (bitmap != null) {
    ...
    public static Bitmap excutePostForBitMap(String url, final int sampleSize) {
        try {
            Bitmap bitMap = null;
