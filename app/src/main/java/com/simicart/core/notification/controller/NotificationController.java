		...
		if (notificationData.getType().equals("1")) {
			...
			if (notificationData.getCategoryID() != null
				...
				if (notificationData.getHasChild().equals("1")) {
					...
					((CategoryDetailFragment)fragment).setCategoryId(notificationData.getCategoryID());
					((CategoryDetailFragment)fragment).setCatName(notificationData.getCategoryName());
				}
			}
		} else {
