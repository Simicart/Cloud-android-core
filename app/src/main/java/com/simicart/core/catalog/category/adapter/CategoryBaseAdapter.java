...
public class CategoryBaseAdapter extends BaseAdapter {
	...
	protected ArrayList<CategoryEntity> categoryList = null;
	protected LayoutInflater inflater;

	public CategoryBaseAdapter(Context context, ArrayList<CategoryEntity> listMh) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String cateName = this.categoryList.get(position).getName();
