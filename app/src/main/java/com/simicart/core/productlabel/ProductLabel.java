package com.simicart.core.productlabel;
...
public class ProductLabel {
    ...
    public ProductLabel(String method, RelativeLayout view) {

        this.context = view.getContext();

        String imageLabel = "http://demo.magestore.com/simicart/simipos3/media/productlabel/label/saleoff_big.png";
        String imagetext = "20 %";
        String positionLabel = "1";
